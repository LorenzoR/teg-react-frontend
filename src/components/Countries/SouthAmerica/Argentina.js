...
const argentina = props => {
    return (
        <g id="argentina" onclick="countryClicked('argentina')">
                        <path
                        id="argentina-border"
                        fill="#6bb682"
                        fillRule="evenodd"
                        ...
                        onclick="countryClicked('argentina')"
                        ></path>
                        <path
                        ...
                        onclick="countryClicked('argentina')"
                        onmouseout="countryMouseOut('argentina')"
                        onmouseover="countryMouseOver('argentina')"
