...
const colombia = props => {
    return (
        <g id="colombia" onclick="countryClicked('colombia')">
            <path
            id="colombia-border"
            fill="#6bb682"
            fillRule="evenodd"
            ...
            onclick="countryClicked('colombia')"
            onmouseout="countryMouseOut('colombia')"
            onmouseover="countryMouseOver('colombia')"
            ></path>
            <path
            id="colombia-filling"
            fill="#9be09e"
            ...
            <circle
                ...
                cy="-446.178"
                r="37.706"
                fill={props.countryState.player ? props.countryState.player.color : '#e03981'}
                stroke="#000"
            ...
            >
                ...
                {props.countryState ? props.countryState.troops : '1'}
                </tspan>
            </text>
            </g>
        </g>
