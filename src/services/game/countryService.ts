...
class CountryService {
    static getCountryContinent(country: string) {
    ...
    static canAttack(source: Country, target: Country) {
        // Same player
    ...
    static areNeighbours(source: string, target: string) {
        return Neighbours[source].includes(target);
    }

    static getNeighbours(country: string) {
